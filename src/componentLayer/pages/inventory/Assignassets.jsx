...
function Assignassets() {
  return (
    <div>
      <BackButton heading=" Add Data" content="Back" />
      <div className="container-fluid">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <div className="table-responsive table-scroll table-card border-0">
              <table className="table table-centered align-middle table-nowrap equal-cell-table table-hover">
                <thead>
                  <tr className="">
                    ...
                    <th scope="col" className="fs-13 lh-xs  fw-600 text-truncate " style={{ maxWidth: "150px" }}>
                      Name
                    </th>
                    <th scope="col" className="fs-13 lh-xs  fw-600  ">
                      Branch
