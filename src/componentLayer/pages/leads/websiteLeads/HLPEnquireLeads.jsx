...
export default function HLPEnquireLeads() {
  ...
  return (
    <div>
      <BackButton heading="HLP Enquire Leads" content="Back" />
                ...
                <div className="table-responsive table-container table-scroll table-card border-0 bg_white">
                  <table className="bg_white table table-centered align-middle table-nowrap equal-cell-table table-hover">
                    ...
                    <tbody className="bg_white">
                      <tr>
                        <td className="fs-13 lh-xs fw-semibold text_color">
                          01
                        </td>
                        <td className="fs-13 lh-xs text_color text-truncate"style={{maxWidth:"150px"}}>Rahul</td>
                        <td className="fs-13 lh-xs  text_color text-truncate"style={{maxWidth:"150px"}}>
                          Rahul@Rahul.com
                        </td>
                        <td className="fs-13 lh-xs  text_color">B.tech</td>
                        <td className="fs-13 lh-xs  text_color">Hyderabad</td>

                        <td className="fs-13 lh-xs  text_color">1234567890</td>

                        <td className="fs-13 lh-xs text_color">12-04-2012</td>
                      </tr>
